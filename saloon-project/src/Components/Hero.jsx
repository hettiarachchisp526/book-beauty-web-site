...
const Hero = () => {
  useEffect(() => {
    ...
    if (btnText) {
      btnText.innerHTML = btnText.innerHTML.split('').map((character) => (
        // eslint-disable-next-line react/jsx-key
        <span className="absolute origin-[40px_40px] text-white" style="transform: rotate(${index * 15}deg) translateX(40px);">${character}</span>
      )).join('');
    }
  }, []);
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="w-full mb-8 text-left">
          <h1 className="w-full font-bold leading-tight text-[#4A4A4A] text-7xl">
            ...
            <span className="text-[#FB7902]"style={{ fontFamily: "Playfair Display, serif" }}>confidence.</span>
          </h1>
          <p className="w-full mt-4 text-2xl text-[#1E1E1E]">
            Discover our retreat for men and boys, where style meets comfort.
            From sharp cuts to refreshing treatments, our skilled barbers deliver top-notch grooming designed to boost your confidence.
          </p>
        </div>
        ...
        <a href="mailto:samuelabera87@gmail.com" id="contact_btn"
                ...
                <p
                    className="text-white font-bold w-[10rem] h-[6rem] flex justify-center mt-[135px] ml-[-15px]">
                    BOOK NOW
                </p>
            </a>
